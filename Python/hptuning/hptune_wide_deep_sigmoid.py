...
def train_model(model_path, simulations_training, simulations_validation, actuals_training,actuals_validation, batch_size=64, 
    ...
    layer1 = keras.layers.Dense(units=100, kernel_initializer='glorot_uniform', activation='sigmoid')(inputA)
    
    hidden1 = keras.layers.Dense(units=100, kernel_initializer='glorot_uniform', activation='sigmoid')(layer1)
    
    hidden2 = keras.layers.Dense(units=100, kernel_initializer='glorot_uniform', activation='sigmoid')(hidden1)
    
    hidden3 = keras.layers.Dense(units=100, kernel_initializer='glorot_uniform', activation='sigmoid')(hidden2)
    
    hidden4 = keras.layers.Dense(units=100, kernel_initializer='glorot_uniform', activation='sigmoid')(hidden3)
...
if __name__=='__main__':
    ...
    train_model('C:\\Users\\dflanner\\qed\\Aspen\\MarginOptimization\\dev\\hptuning\\wide_deep_sigmoid\\', simulations_training, simulations_validation, actuals_training, actuals_validation)
