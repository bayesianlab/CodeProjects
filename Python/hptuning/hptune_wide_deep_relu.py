...
def train_model(model_path, simulations_training, simulations_validation, actuals_training,actuals_validation, batch_size=32, 
    ...
    hidden1 = keras.layers.Dense(units=100, kernel_initializer='glorot_uniform', activation='relu')(layer1)
    
    hidden2 = keras.layers.Dense(units=100, kernel_initializer='glorot_uniform', activation='relu')(hidden1)
    
    hidden3 = keras.layers.Dense(units=100, kernel_initializer='glorot_uniform', activation='relu')(hidden2)
    
    hidden4 = keras.layers.Dense(units=100, kernel_initializer='glorot_uniform', activation='relu')(hidden3)
