...
def train_model(model_path, simulations_training, simulations_validation, actuals_training,actuals_validation, batch_size=64, 
    ...
    a1 = keras.layers.Activation(activation='sigmoid')(layer1)
...
if __name__=='__main__':
    ...
    train_model('C:\\Users\\dflanner\\qed\\Aspen\\MarginOptimization\\dev\\hptuning\\wide\\', simulations_training, simulations_validation, actuals_training, actuals_validation)
