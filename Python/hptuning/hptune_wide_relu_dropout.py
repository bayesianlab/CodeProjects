...
def train_model(model_path, simulations_training, simulations_validation, actuals_training,actuals_validation, batch_size=64, 
    ...
    d1 = keras.layers.Dropout(rate=.1)(layer1)
    hidden1 = keras.layers.Dense(units=100, kernel_initializer='glorot_uniform', activation='relu')(d1) 
    d2 = keras.layers.Dropout(rate=.1)(hidden1)
    hidden2 = keras.layers.Dense(units=100, kernel_initializer='glorot_uniform', activation='relu')(d2)
    d3 = keras.layers.Dropout(rate=.1)(hidden2)
    hidden3 = keras.layers.Dense(units=100, kernel_initializer='glorot_uniform', activation='relu')(d3)
    d4 = keras.layers.Dropout(rate=.1)(hidden3)
    hidden4 = keras.layers.Dense(units=100, kernel_initializer='glorot_uniform', activation='relu')(d4)
    d5 = keras.layers.Dropout(rate=.1)(hidden4)

    out = Dense(1, activation='sigmoid')(d5)
