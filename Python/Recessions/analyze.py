...
db_name = 'Securities'
#%%
factors = pd.read_csv('/home/dillon/CodeProjects/CProjects/build/recession_factor_yhms_2024_7_22_17_42_5/factors.csv', header=None)
...
# %%
orthants = pd.read_csv('/home/dillon/CodeProjects/CProjects/build/recession_factor_yhms_2024_7_22_17_42_5/orthant_probs.csv', header=None)
...
plt.legend() 
plt.savefig('/home/dillon/gdrivelocal/LatexDocuments/probit/logprob.png')
# %%
...
plt.legend()
plt.savefig('/home/dillon/gdrivelocal/LatexDocuments/probit/prob01.png')

# %%
loaders = pd.read_csv('/home/dillon/CodeProjects/CProjects/build/test_yhms_2024_7_25_11_5_7/loadings.csv', header=None)
