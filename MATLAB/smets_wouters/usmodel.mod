...
ctrend ctrend2 ctrend3 ctrend4 
...
ctrend4,0.3982,0.1,0.8,NORMAL_PDF,0.4,0.10;
...
varobs dy dc dinve labobs pinfobs dw robs;
  ...
  estimation(optim=('MaxIter',200),datafile=usmodel_data,mode_compute=0,mode_file=usmodel_mode,first_obs=71,presample=4,lik_init=2,prefilter=0,mh_replic=250000,mh_nblocks=1,mh_jscale=0.20,mh_drop=0.2);
//estimation(optim=('MaxIter',200),datafile=usmodel_data,mode_compute=1,first_obs=71,presample=4,lik_init=2,prefilter=0,mh_replic=250000,mh_nblocks=1,mh_jscale=0.20,mh_drop=0.2, moments_varendo,filtered_vars,smoother);
